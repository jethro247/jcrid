...
<xsl:stylesheet version="2.0" 
        ...
        <table class="copyright" id="table_copyright">
          <tr>
            <td>
              ...
              Mr Site Takwaway Website, Search Engine Optimisation and Sitemap Maker <a href="http://www.mrsite.co.uk">Mr Site</a>
            </td>
          </tr>
        </table>
      </body>
  ...
  <xsl:template name="siteindexTable">
    <h3>This Google Sitemap file was created by <a href="http://www.mrsite.co.uk">Mr Site Takeaway Website SEO</a>.</h3>          
